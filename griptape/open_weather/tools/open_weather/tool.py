...
class OpenWeatherTool(BaseTool):
    ...
    def _fetch_coordinates(self, location: str) -> tuple[float, float | None] | None:
    ...
    @activity(
        config={
            ...
            "schema": Schema(
                {
                    Literal(
                        "location", description="Location to fetch weather data for."
                    ): str
                }
            ),
        },
    ...
    @activity(
        config={
            ...
            "schema": Schema(
                {
                    Literal(
                        "location", description="Location to fetch hourly forecast for."
                    ): str
                }
            ),
        },
    ...
    @activity(
        config={
            ...
            "schema": Schema(
                {
                    Literal(
                        "location", description="Location to fetch daily forecast for."
                    ): str
                }
            ),
        },
